...
\begin{figure}[!ht]
\textbf{FAZER:} amostragem de pontos
\label{amostragem_de_pontos}
\caption{Diagrama de pontos amostrados}
\end{figure}
...
Para este tipo de problema uma boa solução é o uso de múltiplas hipóteses da amostra. Ou seja, cada amostra $e_{i,j}$ está associada a um conjunto de hipóteses $\{e'_{i,j,l}\}$, e somente as correspondências mais prováveis seriam usadas no processo de minimização.
